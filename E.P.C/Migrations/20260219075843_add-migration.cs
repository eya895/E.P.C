...
namespace E.P.C.Migrations
{
    ...
    public partial class addmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "MotherBoard_Brand", "Description", "Discriminator", "MotherBoard_FormFactor", "ImageUrl", "MaxRAMCapacity", "MotherBoard_Model", "Price", "RAMSlots", "RAMType", "SocketType" },
                values: new object[,]
                {
                    { 19, "ASUS", "ASUS ROG Strix B550-F Gaming MotherBoard AM4 ATX DDR4", "MotherBoard", "ATX", "https://tms.co.il/image/catalog/products/90MB19V0-M0EAY0/M2VOw178Qc.jpg", 128, "ROG Strix B550-F Gaming", 803.0, 4, "DDR4", "AM4" },
                    { 20, "MSI", "MSI MAG B660M Mortar WiFi DDR4 MotherBoard LGA1700 Micro-ATX", "MotherBoard", "Micro-ATX", "https://media.ldlc.com/r1600/ld/products/00/05/94/22/LD0005942218.jpg", 128, "MAG B660M Mortar WiFi DDR4", 910.0, 4, "DDR4", "LGA1700" },
                    { 21, "Gigabyte", "Gigabyte Z790 AORUS ELITE AX MotherBoard LGA1700 ATX DDR5", "MotherBoard", "ATX", "https://tms.co.il/image/catalog/products/GZ790AORUSELITEAX/lJVeEI0BTp.png", 128, "Z790 AORUS ELITE AX", 1200.0, 4, "DDR5", "LGA1700" }
                });
